 ...
 *
function corrections_civicrm_navigationMenu(&$menu) {
  _corrections_civix_insert_navigation_menu($menu, NULL, array(
    'label' => ts('The Page', array('domain' => 'be.aivl.corrections')),
    'name' => 'the_page',
  ...
  _corrections_civix_navigationMenu($menu);
} // */
